...
namespace alisveris.Migrations
{
    ...
    [Migration("20241207142704_UpdateRequiredFields")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SiparisDetayi", b =>
                {
                    b.Property<int>("DetayID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Icerir", b =>
                {
                    b.HasOne("SiparisDetayi", "SiparisDetayi")
                        .WithMany("Icerir")
            ...
            modelBuilder.Entity("Kargo", b =>
                {
                    b.HasOne("Siparis", "Siparis")
                        .WithOne("Kargo")
                        .HasForeignKey("Kargo", "SiparisID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
